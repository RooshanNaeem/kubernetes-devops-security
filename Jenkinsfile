pipeline {
  ...
  stages {
      ...
      stage('SonarQube Analysis - SAST') {
            steps{
            sh "mvn sonar:sonar -Dsonar.projectKey=numeric-app -Dsonar.host.url=http://devsecops-demo2.eastus.cloudapp.azure.com:9000 -Dsonar.login=e24d9efc489613cde7805b4ea7d0b77f1616a163"
        }  
      }
